                      ...
                      <asp:Repeater ID="rptMathang" runat="server">
                          <HeaderTemplate>
                              <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <th>STT</th><th>Mã</th><th>Hình ảnh</th><th>Tên mặt hàng</th><th>Đơn vị tính</th><th>Loại mặt hàng</th><th>Thời gian tạo</th><th>Trạng thái</th><th>Tác vụ</th>
                                    </tr>
                                </thead>
                          </HeaderTemplate>
                          <ItemTemplate>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href='Them_SuaMatHang.aspx?IDMathang=<%# Eval("sMaMH") %>&mode=sua'><img src="assets/images/mathang/<%#Eval("sHinhanh")%>" title="<%#Eval("sTenMH") %>" style="height: 150px; width: 150px;"></a>
                                    </td>
                                    <td><%# Eval("sTenMH") %></td>
