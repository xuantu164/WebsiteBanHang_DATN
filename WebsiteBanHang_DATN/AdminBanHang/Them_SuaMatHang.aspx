            ...
            <div class="card-body">
                ...
                <form class="form-sample">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                <div class="col-sm-9">
                                    <label for="exampleTextarea1" style="margin-bottom: 20px;">Hình ảnh mặt hàng</label>
                                    <br />
                    ...
                    <div class="form-group" runat="server" id="MaMH">
                        <label for="exampleTextarea1">Mã mặt hàng: </label>
                        <asp:Label ID="lbMaMH" runat="server" Text="Label"></asp:Label>
                    </div>
                    <div class="form-group" runat="server" id="MaFileAnh">
                        <label for="exampleTextarea1">File ảnh: </label>
                        <asp:Label ID="lbFileAnh" runat="server" Text="Label"></asp:Label>
                    </div>
